...
async def play(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/RioGroupSupport"),
                    InlineKeyboardButton("⛑ Channel", url="https://t.me/RiobotSupport"),
                ],
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        thumbnail = "https://telegra.ph/file/47ba4feefcaeb718b7ca6.jpg"
...
async def lol_cb(b, cb):
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/RioGroupSupport"),
                    InlineKeyboardButton("🛡️ Channel", url="https://t.me/RioBotsupport"),
                ],
                [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
